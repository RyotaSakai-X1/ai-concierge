...
```bash
browser-use screenshot http://localhost:3458/{nn}-{slug}.html --output docs/outputs/{slug}/design/screenshots/{nn}-{slug}.png
```
...
スクリーンショット保存先: `docs/outputs/{slug}/design/screenshots/`
